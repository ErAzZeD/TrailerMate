...
bool interfaces__msg__trailer_angle__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.msg._trailer_angle.TrailerAngle", full_classname_dest, 42) == 0);
  }
  interfaces__msg__TrailerAngle * ros_message = _ros_message;
  {  // trailer_angle
    ...
    ros_message->trailer_angle = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of TrailerAngle */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.msg._trailer_angle");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TrailerAngle");
