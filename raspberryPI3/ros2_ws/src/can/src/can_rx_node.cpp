    ...
    int readData(){
        ...
        while (rclcpp::ok()){
            ...
            */
                ...
                imu_raw_msg.linear_acceleration.x = acc_x * pow(10,-2);    //Conversion to [m/s²]
                imu_raw_msg.linear_acceleration.y = acc_y * pow(10,-2);    //Conversion to [m/s²]
                imu_raw_msg.linear_acceleration.z = acc_z * pow(10,-2);    //Conversion to [m/s²]
