...
bool interfaces__msg__angle_trailer__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.msg._angle_trailer.AngleTrailer", full_classname_dest, 42) == 0);
  }
  interfaces__msg__AngleTrailer * ros_message = _ros_message;
  {  // trailer_angle
...
{
  /* NOTE(esteve): Call constructor of AngleTrailer */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.msg._angle_trailer");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AngleTrailer");
