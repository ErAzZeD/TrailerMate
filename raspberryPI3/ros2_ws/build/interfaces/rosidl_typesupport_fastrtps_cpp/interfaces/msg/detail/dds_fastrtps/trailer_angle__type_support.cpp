...
#include "interfaces/msg/detail/trailer_angle__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::msg::TrailerAngle & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::msg::TrailerAngle & ros_message)
{
  // Member: trailer_angle
  cdr >> ros_message.trailer_angle;
...
{
  auto typed_message =
    static_cast<const interfaces::msg::TrailerAngle *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::TrailerAngle *>(
    untyped_ros_message);
...
static size_t _TrailerAngle__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TrailerAngle(full_bounded, is_plain, 0);
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_TrailerAngle__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, TrailerAngle)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_TrailerAngle__handle;
}
